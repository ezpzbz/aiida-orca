"""Typed input builder for single-point energy calculations."""

from ._common import build_parameters


def build_single_point_inputs(
    *,
    functional: str,
    basis: str,
    charge: int,
    ...
    """Build the ``parameters`` dict for a single-point energy calculation.

    :param functional: method/functional, e.g. ``'HF'``, ``'B3LYP'``.
    ...
    :param blocks: ``%block ... end`` sections.
    """
    keywords = [functional]
    if dispersion:
